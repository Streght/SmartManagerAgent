...
/*        if (isNetworkAvailable()) {
        ...
        Log.d("MainActivity","Helloo, create");

        // Creation of the server thread
        Thread t = new Thread(new Runnable() {
            public void run()
            {
                Log.d("MainActivity","Create server thread");
                createServer();
        ...
        Log.d("MainActivity","Client handler");
    ...
    protected void createServer() {
        ...
        Log.d("MainActivity","Port: " + portNumber);
        ...
        try (ServerSocket serverSocket = new ServerSocket(portNumber)) {
            ...
            Log.d("MainActivity","Could not listen on port " + portNumber);
            System.exit(-1);
        }
    }
